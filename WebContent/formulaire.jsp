<jsp:directive.page contentType="text/html;charset=ISO-8859-15" pageEncoding="UTF-8" />
<html>
			...
			<div class="row">
				...
				<div class="input-field col s12 m6">
					<i class="material-icons prefix">account_circle</i> <input
						...
						title="Le nom ne doit contenir que des lettres" required>
				...
				<div class="input-field col s12 m6">
					<i class="material-icons prefix">hotel</i> <input value=""
						...
						title="Entrer un nombre" required> <label>Nombre
						de nuitée</label>
				</div>

				<div class="input-field col s12 m6">
					<i class="material-icons prefix">accessibility</i> <select
						name="nbPersonne" required>
